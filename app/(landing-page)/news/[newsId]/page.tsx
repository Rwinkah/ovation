...
const blogs = [
  {
    ...
    paragraphs: [
      ...
      },
      {
        ...
        paragraphDetails: `Use the Howey Test to determine if your project falls under an “investment contract” definition and thus a Security. If it does, you will need to register as a Security. Consult a lawyer that is familiar with SEC Securities law and NFTs as a technology. Disclaimer: This is not legal advice, consult a lawyer when making decisions regarding securities law.`,
        list: [
          {
            listHeader: '',
            listDetails: '',
  ...
  },
  {
    ...
    blogHeader: `Imagine if X, OpenSea, and Discord had a Web3 baby, that would be Ovation- The First NFT Super App.`,
    blogDetails: `The current NFT landscape consists of a multitude of disconnected applications where NFT enthusiasts manage portfolios across multiple wallets and blockchains`,
    paragraphs: [
      {
        paragraphHeader: 'What determines a Security?',
        paragraphDetails: `If there is an “investment of money in a common enterprise with a reasonable expectation of profits to be derived from the efforts of others,” the transaction is subject to disclosure and registration requirements under the Securities Act of 1933 and the Security Exchange Act of 1934. In others words a Security.`,
