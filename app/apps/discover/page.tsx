...
export default function page() {
  return (
    <div className="flex flex-col w-full  bg-[#111115] h-fit items-center justify-center">
      <div
        className="h-[250px] w-full g-orange-400 flex items-center justify-center bg-cover shadow pl-5 pr-5"
...
function DiscoverHolders({ setFilter, Filter, data }: DiscoverHoldersProps) {
  ...
  useEffect(() => {
    ...
    filterData()
  }, [Filter]) // This effect depends on `Filter` and `data`, it runs whenever either changes
